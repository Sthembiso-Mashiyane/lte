<template>
  <div class="pt-5">
    <div class="position-relative">
      <img src="../../assets/images/home/content-image-1.png" class="img-move img-move-1 img-fluid"
           alt="LTE Image 1">
      ...
      <img src="../../assets/images/home/content-image-1.png" class="img-fluid invisible d-none d-md-block">
    </div>

    <div class="row py-md-5">
      <div class="col-md-6 p-5 card text-center border-0 order-2 order-md-1">
        <div class="text-center my-auto">
          <div class=" card-block d-flex">
      ...
      <div class="col-md-6 p-0 order-1 order-md-2">
        <img src="../../assets/images/home/content-image-2.png" class="img-fluid" alt="LTE Image 2">
      </div>
    </div>
    ...
    <div class="position-relative">
      ...
      <img src="../../assets/images/home/content-image-3.jpg" class="img-fluid invisible d-none d-md-block">
    </div>
    ...
    <div class="row p-0">
        ...
        <div class="text-center my-auto">
          <div class=" card-block d-flex">
            <div class="card-body text-left">
              ...
              <div class="row pt-5"><p>
                LTE Holdings is proud to be a 100% black-owned consultancy and advisory services company that boasts
                award winning personnel in the expertise we offer.
              </p></div>
      ...
      <div class="col-md-6 p-0 order-1 order-md-2">
        <img src="../../assets/images/home/content-image-4.png" class="img-fluid" alt="LTE Image 4">
      </div>
    </div>
  </div>
</template>
