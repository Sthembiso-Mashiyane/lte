        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="header-top-items d-flex justify-content-between align-items-center">
              <div class="logo">
                <a href="/"><img src="../assets/lte-header-logo.png" alt=""></a>
              </div>
              <div class="header-top-info d-none d-md-block">
                <ul>
                  <li>
                    ...
                    <span>Email</span>
                    <a href="mailto:needhelp@lteconsulting.co.za">needhelp@lteconsulting.co.za</a>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span>Visit</span>
                    <a href="#">5 Eglin Rd Sunninghill Sandton, 2157</a>
                  </li>
                </ul>
              </div>
            </div>
